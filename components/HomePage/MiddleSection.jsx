...
const MiddleSection = () => {
  return (
    ...
    <div className='flex flex-col items-center mt-10'>
      <h1 className='relative md:ml-5 text-green-700 underline text-3xl font-serif font-bold'>
  ...
  <div className='flex w-80 h-60  bg-yellow-100 border rounded-lg text-center text-white'>
    ...
    <Link href="/DoctorPage"><button className='text-sm w-30 h-10 text-black bg-gray-200 border rounded-lg right-96 ml-8 top-32 relative px-12  hover:transform hover:-translate-y-1 hover:bg-green-700 hover:text-white transition duration-300'>Read More</button>
    </Link>
  </div>
  ...
  <div className='flex w-80 h-60 bg-pink-100 border rounded-lg text-white relative'>
    ...
    <Link href="/DoctorPage"><button className='text-sm w-30 h-10 text-black bg-gray-200 border rounded-lg right-96 top-32 relative px-12  hover:transform hover:-translate-y-1 hover:bg-green-700 hover:text-white transition duration-300'>Read More</button>
    </Link>
  </div>
</div>
